<?php
    ...
    $sql = mysqli_select_db($con,$database) or die("unable to connect to database");	
      ...
      //$link = mysqli_connect(127.0.0.1,root,"","travel",)
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Provides student a pass for their daily life to travel to/from Panimalar Institute Of Technology,Poonamalle</p>
            </div>
